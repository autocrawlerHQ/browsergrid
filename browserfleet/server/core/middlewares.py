"""
Middleware components for browserfleet
...
class BrowserfleetMiddleware(BaseHTTPMiddleware):
    """Base middleware class for browserfleet with request/response hooks"""
...
class ApiKeyMiddleware(BrowserfleetMiddleware):
    """
...
class RequestLogMiddleware(BrowserfleetMiddleware):
...
class RateLimitMiddleware(BrowserfleetMiddleware):
