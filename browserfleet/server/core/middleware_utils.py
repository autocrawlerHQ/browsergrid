...
from browserfleet.server.core.settings import MIDDLEWARE
...
def register_middleware(
    ...
    try:
        ...
        print(f"Error registering middleware {class_path}: {e}")
        return False
...
def apply_middlewares(app: FastAPI, middleware_config: List[Dict[str, Any]], **global_kwargs: Any) -> FastAPI:
    ...
    for middleware in middleware_config:
        ...
        try:
            ...
            print(f"Error applying middleware {middleware_class_path}: {e}")
            continue
