...
from browserfleet.server.workerpool.schemas import (
    WorkPool, WorkPoolCreate, WorkPoolWithRelations,
)
from browserfleet.server.workerpool.enums import WorkPoolStatus, ProviderType
...
async def create_work_pool(
    ...
    from browserfleet.server.workerpool.models import WorkPool as WorkPoolModel
