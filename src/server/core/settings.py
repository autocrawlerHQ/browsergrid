...
MIDDLEWARE = [
    ...
    {
        "class": "src.server.core.middlewares.ApiKeyMiddleware",
        "kwargs": {
    ...
    # Request logging
    {
        "class": "src.server.core.middlewares.RequestLogMiddleware",
        "kwargs": {
            "log_level": "info" if DEBUG else "error"
        },
    },
    {
        "class": "src.server.core.middlewares.RateLimitMiddleware",
        "kwargs": {
