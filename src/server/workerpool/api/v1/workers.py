...
from src.server.workerpool.schemas import (
...
async def create_worker(
    ...
    """Create a new worker"""
    from src.server.workerpool.models import Worker as WorkerModel
    from src.server.workerpool.models import WorkPool as WorkPoolModel
    import secrets
...
async def claim_pending_session(
    ...
    from src.server.workerpool.models import Worker as WorkerModel
    from src.server.sessions.models import Session as SessionModel
    from src.server.sessions.enums import SessionStatus
