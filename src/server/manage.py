...
import os
import uvicorn
from src.server.core.settings import API_HOST, API_PORT, DEBUG
...
def main():
    ...
    if args.command == "runserver":
        ...
        # Configure Uvicorn
        config_kwargs = {
            "app": "src.server.core.server:server",
            "host": args.host,
            "port": args.port,
        ...
        from src.server.core.db.migrations import upgrade_database
        upgrade_database(args.revision)
    
    elif args.command == "makemigrations":
        from src.server.core.db.migrations import create_migration
